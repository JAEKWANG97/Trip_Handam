# 🍳 여행한담
<img src="https://github.com/sangmin0806/Trip_Handam/blob/main/exec/images/메인페이지.png?raw=true" width="700" height="350">
...
처리율 제한 장치 적용
동시성 제어
Hadoop, Spark, Redis를 통한 주기적인 피드 추천 적용
ElasticSearch를 활용한 빠른 피드 검색
